...
const UI = {
  en: {
    ...
    homeClueText: 'The puppet room clock is five minutes ahead of the foyer clock.',
    homeClueCta: 'Open the second clue →',
    ...
    portalGamesTag: 'Featured game',
    portalGamesTitle: 'Akshifha — اكشفها',
    portalGamesDesc: 'Trace a route, untangle a timeline, and test an explanation. Eleven short cases, each with two clues that work together.',
    portalGamesStat1: '11 original cases',
    portalGamesStat2: 'Hints when you need them',
    ...
    audiencePathsEyebrow: 'Three ways to begin',
    audiencePathsTitle: 'Choose the kind of challenge you want',
    audiencePathsText: 'Start a short, useful activity without registering. Your progress stays separate from competitive scores.',
    audienceFriendsTitle: 'Challenge Friends',
    audienceFriendsText: 'Compare reasoning together in a calm, untimed session.',
    audienceFriendsCta: 'Open social challenges →',
    audienceUniversityTitle: 'University Essentials',
    audienceUniversityText: 'Practice a concept, use it in a new situation, then revisit it later.',
    audienceUniversityCta: 'Open learning paths →',
    audienceExplorersTitle: 'Young Explorers',
    audienceExplorersText: 'Age-specific pathways for curious learners, without open chat or stranger matching.',
    audienceExplorersCta: 'Explore by age →',
  ...
  ar: {
    ...
    homeClueTime: '18:12–18:27',
    homeClueText: 'ساعة غرفة الدمى متقدّمة بخمس دقائق على ساعة البهو.',
    homeClueCta: 'افتح الدليل الثاني ←',
    ...
    portalGamesTag: 'اللعبة المميّزة',
    portalGamesTitle: 'اكشفها',
    portalGamesDesc: 'تتبّع مسارًا، أو رتّب أحداثًا، أو اختبر تفسيرًا. إحدى عشرة قضية قصيرة، في كل منها دليلان يتكاملان.',
    portalGamesStat1: '١١ قضية أصلية',
    portalGamesStat2: 'تلميحات عند الحاجة',
    ...
    audiencePathsEyebrow: 'ثلاث طرق للبداية',
    audiencePathsTitle: 'اختر نوع التحدي الذي تريده',
    audiencePathsText: 'ابدأ نشاطاً قصيراً ومفيداً من دون تسجيل. يبقى تقدّمك منفصلاً عن النقاط التنافسية.',
    audienceFriendsTitle: 'تحدَّ الأصدقاء',
    audienceFriendsText: 'قارنوا الاستدلال معاً في جلسة هادئة بلا مؤقّت.',
    audienceFriendsCta: 'افتح التحديات الاجتماعية ←',
    audienceUniversityTitle: 'أساسيات الجامعة',
    audienceUniversityText: 'تدرّب على مفهوم، واستخدمه في موقف جديد، ثم عُد إليه لاحقاً.',
    audienceUniversityCta: 'افتح مسارات التعلّم ←',
    audienceExplorersTitle: 'المستكشفون الصغار',
    audienceExplorersText: 'مسارات مناسبة للعمر للمتعلمين الفضوليين، بلا دردشة عامة أو مطابقة غرباء.',
    audienceExplorersCta: 'استكشف حسب العمر ←',

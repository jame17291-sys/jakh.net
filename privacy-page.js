(() => {
  ...
  const copy = Object.freeze({
    en: {
      title: 'Privacy Centre | Riddle Arabia',
      description: 'Control analytics, export your Riddle Arabia account data, permanently delete your account, and read the bilingual Riddle Arabia privacy notice.',
      ...
      deleteConfirm: 'Permanently delete this Riddle Arabia account and all account-linked data? This cannot be undone.',
    ...
    ar: {
      ...
      deleteConfirm: 'هل تريد حذف حساب ريدل أرابيا هذا وجميع البيانات المرتبطة به نهائياً؟ لا يمكن التراجع عن ذلك.',

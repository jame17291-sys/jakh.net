  ...
  const PAGES = {
    ...
    about: {
      en: {
        ...
        metaDescription: 'Learn how JAKH organizes, translates, and improves its 3,553 bilingual questions, plus how to report a correction.',
      ...
      ar: {
        ...
        metaDescription: 'تعرّف إلى طريقة تنظيم 3,553 سؤالًا في JAKH، وترجمتها وتحسينها، وتعلّم كيف ترسل لنا تصحيحًا.',
